  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: 'h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-secondary/70/50 [&:has([aria-selected])]:bg-secondary/70 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 rounded-1',
        day_button: cn(
        ...
        today: 'rounded-md aria-selected:bg-primary bg-secondary/70 hover:bg-secondary/50 text-foreground',
        outside:
          'day-outside text-muted-foreground opacity-50 aria-selected:bg-secondary/70/50 aria-selected:text-muted-foreground aria-selected:opacity-30',
        disabled: 'text-muted-foreground opacity-50',
        range_middle: 'aria-selected:bg-secondary/70 aria-selected:text-secondary/70-foreground',
        hidden: 'invisible',
        ...classNames,
      }}
      components={{
        ...
        MonthCaption: ({ calendarMonth }) => {
          return (
            <div className="inline-flex gap-2">
              ...
              >
                <SelectTrigger className="w-fit gap-1 border-none p-0 focus:bg-secondary/70 focus:text-secondary/70-foreground">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {MONTHS.map((month) => (
    ...
    return (
      <div className="flex h-10 items-center">
        <Select defaultValue={period} onValueChange={(value: Period) => handleValueChange(value)}>
          <SelectTrigger
            ref={ref}
            className="w-[65px] focus:bg-secondary/70 focus:text-secondary/70-foreground"
  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          'w-[48px] text-center font-mono text-base tabular-nums caret-transparent focus:bg-secondary/70 focus:text-secondary/70-foreground [&::-webkit-inner-spin-button]:appearance-none',
          className,
        )}
