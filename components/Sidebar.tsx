      ...
      <TooltipProvider delayDuration={200}>
        <Tooltip disableHoverableContent={true}>
          <TooltipTrigger asChild>
            <Link href={slug}>
              <div className={`w-full flex items-center p-3 gap-4 rounded-lg ${expanded ? "justify-start" : ""} ${active ? "bg-primary" : "cursor-pointer hover:outline outline-secondary outline-1 active:bg-secondary/20"}`}>
